...
public class BillingController {
	 ...
	 */
	private static void notifyPurchaseStateChange(String itemId, Transaction.PurchaseState state, String signedData, String signature) {
		for (IBillingObserver o : observers) {
			o.onPurchaseStateChanged(itemId, state, signedData, signature);
		}
	}
	...
	protected static void onPurchaseStateChanged(Context context, String signedData, String signature) {
		...
		for (Transaction p : purchases) {
			...
			notifyPurchaseStateChange(p.productId, p.purchaseState, signedData, signature);
		}
