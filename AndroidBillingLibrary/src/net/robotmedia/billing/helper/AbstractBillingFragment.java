...
public abstract class AbstractBillingFragment extends Fragment implements BillingController.IConfiguration {
	...
	public void onCreate(android.os.Bundle savedInstanceState) {
		...
		mBillingObserver = new AbstractBillingObserver(getActivity()) {
			...
			public void onPurchaseStateChanged(String itemId, PurchaseState state, String signedData, String signature) {
				AbstractBillingFragment.this.onPurchaseStateChanged(itemId, state, signedData, signature);
			}
	...
	public abstract void onPurchaseStateChanged(String itemId, PurchaseState state, String signedData, String signature);;
