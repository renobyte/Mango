...
public class AboutActivity extends MangoActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        builder.append("Mango uses the ActionBarSherlock library to implement Action Bar functionality on pre-Honeycomb platforms.  Check it out for free at <actionbarsherlock.com>.\n\n");
        ...
        builder.append("Mango is copyright (c)2009-2012 Victor Barrancos/Leetsoft. All rights reserved.\n\n");
        builder.append("Thanks for using Mango! ^___^\n\n\n");
