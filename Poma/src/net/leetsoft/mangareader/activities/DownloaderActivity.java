...
public class DownloaderActivity extends MangoActivity
{
    ...
    private void pauseResumeClicked()
    {
        ...
        {
            Mango.alert(
                    "Mango has paused the download because there is no mobile data connectivity, or because you are on a phone call.\n\nThe download will automatically resume once Mango can connect again.",
    ...
    private void checkForSavedQueue()
    {
        ...
        if (mQueueArray.length == 0 && file.exists())
        {
            ...
            alert.setMessage("It seems like Mango shut down last time without finishing all of your downloads.  Would you like to resume downloading them now?");
